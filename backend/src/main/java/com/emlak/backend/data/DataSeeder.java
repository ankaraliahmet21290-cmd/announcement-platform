...
public class DataSeeder implements CommandLineRunner {
        ...
        public DataSeeder(TenantRepository tenantRepository, AppUserRepository appUserRepository,
                        PropertyRepository propertyRepository, LeadRepository leadRepository,
        ...
        public void run(String... args) {
                ...
                AppUser agent1 = AppUser.builder()
                                ...
                                .phone("+90 537 972 69 11")
                                .whatsapp("905379726911")
                                .role(Role.AGENT)
                ...
                AppUser agent2 = AppUser.builder()
                                ...
                                .password(passwordEncoder.encode("Agent123!"))
                                .phone("+90 541 487 51 05")
                                .whatsapp("905414875105")
                                .role(Role.AGENT)
        ...
        private void seedPropertiesForTenant1(Tenant tenant, AppUser agent1, AppUser agent2) {
                Property p1 = Property.builder()
                                ...
                                .viewCount(142L)
                                .build();
                p1.addImage(PropertyImage.builder().url(
                ...
                Property p2 = Property.builder()
                                ...
                                .viewCount(89L)
                                .build();
                p2.addImage(PropertyImage.builder().url(
                ...
                Property p3 = Property.builder()
                                ...
                                .viewCount(210L)
                                .build();
                p3.addImage(PropertyImage.builder().url(
                ...
                Property p4 = Property.builder()
                                ...
                                .viewCount(65L)
                                .build();
                p4.addImage(PropertyImage.builder().url(
                ...
                Property p5 = Property.builder()
                                ...
                                .viewCount(98L)
                                .build();
                p5.addImage(PropertyImage.builder().url(
                ...
                Property p6 = Property.builder()
                                ...
                                .viewCount(340L)
                                .build();
                p6.addImage(PropertyImage.builder().url(
                ...
                Property p7 = Property.builder()
                                ...
                                .viewCount(175L)
                                .build();
                p7.addImage(PropertyImage.builder().url(
                ...
                Property p8 = Property.builder()
                                ...
                                .viewCount(0L)
                                .build();
                p8.addImage(PropertyImage.builder().url(
